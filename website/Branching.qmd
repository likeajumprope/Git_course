...
*Branching* is a way to work on different parts and versions of a repository at the same time. By default, each repository is created and initiated with a *main* branch. You can commit directly into the main branch as we just did.
...
![Branches are copies of a repository. They allow to develop the repository in different directions.](img/Branching.png)
